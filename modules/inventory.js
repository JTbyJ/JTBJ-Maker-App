    ...
    return `
      <tr>
        ...
        <td style="text-align: right;">
          <button class="btn btn-ghost btn-sm" onclick="openInventoryHistoryModal(${escapeHtml(JSON.stringify(item.sku || ''))})" title="View Cost History">📜</button>
          <button class="btn btn-ghost btn-sm" onclick="openStockAdjustmentModal(${escapeHtml(JSON.stringify(item.sku || ''))})" title="Adjust / Write Off Stock (expired, damaged, used up)">⚠️</button>
